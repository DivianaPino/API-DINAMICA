...
if(isset($_GET["id"]) && isset($_GET["nameId"])){
    ...
    //parse_str: convierte una cadena de texto en un array
    //le pasamos la variable 4data apra que quede dentro de esta variable
    ...
    // propiedades con sus indices en el array
    $columns = array();
