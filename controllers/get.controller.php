...
//*===================================================*/
     ...
     public function getData($table, $select, $orderBy, $orderMode,$startAt, $endAt){
        ...
        //Accedemos al metodo getData() de la clase GetModel 
        //que esta en el  modelo get.model.php sin instanciar
        //un objeto a dicha clase, ya que es un metodo de tipo 
        //stactic y para acceder a ese metodo podemos utilizar "::" 
        $response = GetModel::getData($table, $select, $orderBy, $orderMode,$startAt, $endAt);
    
        //instaciamos un objeto a la clase GetController para
        //acceder al metodo fncResponse(), ya que no es static
